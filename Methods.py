...
def main():
    ...
    g.listbox.insert("end", "                                           JIYAAD RESTAURANT BILLING SYSTEM")
    g.listbox.insert("end", "=================================================")
...
def reset():
    m = mb.askyesno("SYSTEM ALERT", "Reset All..? \n")
...
def recipt():
    ...
    g.listbox.delete(0, 20)
    g.listbox.insert("end", "=================================================")
    g.listbox.insert("end", ("Ref : " + str(x) + "                          JIYAAD RESTAURANT BILLING SYSTEM"))
    g.listbox.insert("end", "=================================================")
    g.listbox.insert("end", "                                                 ")
...
def exit_window():
    m = mb.askyesno("SYSTEM ALERT", "Exit From System..?\n")
    if m == 1:
        sys.exit()
